 ...
 * 自定义布局，图片+标题+数字指示器
 */
public class ImageTitleNumAdapter extends BannerAdapter<ExtInfo.BannersBean, ImageTitleNumAdapter.BannerViewHolder> {

    public ImageTitleNumAdapter(List<ExtInfo.BannersBean> mDatas) {
    ...
    //绑定数据
    @Override
    public void onBindView(BannerViewHolder holder, ExtInfo.BannersBean data, int position, int size) {
...
//                .apply(RequestOptions.bitmapTransform(new RoundedCorners(30)))
        ...
        holder.title.setText(data.getTypeTitle());
