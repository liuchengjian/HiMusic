...
public class CircleProgressBar extends View {
    // 设置属性的默认值
    private int mInnerBackground = Color.parseColor("#cccccc");
    private int mOuterBackground = Color.parseColor("#000000");
    private int mRoundWidth = 12;
    private float mProgressTextSize = 10;
    private int mProgressTextColor = Color.parseColor("#ff00ff");
    ...
    public CircleProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mRoundWidth = (int) array.getDimension(R.styleable.CircleProgressBar_roundWidth, dip2px(1));
