...
public class LyricBean implements Serializable {
    ...
    public static class KlyricBean implements Serializable {
        /**
         * version : 1
         * lyric : [ti:情非得已韩文版]
         [ar:韩文版]
    ...
    public static class TlyricBean implements Serializable {
        /**
         * version : 0
         * lyric :
         */
    ...
    public static class RomalrcBean implements Serializable {
        /**
         * version : 0
         * lyric :
         */
